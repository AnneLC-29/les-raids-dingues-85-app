...
# Base de coordonnées GPS enrichie (avec VIX)
COORDS_VILLES = {
...
with tab_fiche:
    ...
    if course_choisie:
        ...
        inscrits = df_participations[df_participations["Course_Key"] == infos["Course_Key"]]
        ...
        for day in week:
            if day == 0: html_code += '<td class="cal-td cal-empty"></td>'
                ...
                for _, row in courses_jour.iterrows():
                    ...
                    inscrits_df = df_participations[df_participations['Course_Key'] == row['Course_Key']]
